    ...
    return (
        <div className="bg-white min-h-screen font-sans text-zinc-900">
            ...
            <header className="relative pt-32 pb-32 md:pt-48 md:pb-40 overflow-hidden bg-zinc-900">
                ...
                <AnimatedSection className="max-w-4xl mx-auto px-6 relative z-10 text-center space-y-8">
                    <div className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-white border border-buddas-orange/30 text-buddas-orange text-xs font-bold uppercase tracking-wider shadow-sm">
                        <Sparkles className="w-4 h-4" />
                        <span>Premium Events & Weddings</span>
                    </div>

                    <h1 className="text-5xl md:text-7xl font-bold text-white tracking-tight leading-[1.1] font-poppins">
                        {heroTitle || "Exquisite Catering for Unforgettable Moments"}
                    </h1>

                    <p className="text-xl text-buddas-cream/80 max-w-2xl mx-auto leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {serviceTypes?.map((service: any, idx: number) => {
                                ...
                                const themes = [
                                    ...
                                    { bg: 'bg-teal-50', text: 'text-buddas-teal' },
