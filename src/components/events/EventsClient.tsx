    ...
    return (
        <div className="bg-white min-h-screen font-sans text-buddas-dark">
            ...
            <header className="relative h-[85vh] flex items-center justify-center overflow-hidden bg-buddas-dark">
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 text-center text-white space-y-8 animate-in fade-in zoom-in duration-1000">
            ...
            {/* Immersive Break Section (Parallax) */}
